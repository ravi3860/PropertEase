...
<!-- Main Content -->
    <main class="flex-grow flex items-center justify-center py-8">
        <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
            <h2 class="text-2xl font-bold text-teal-800 mb-6 text-center">Add New Property</h2>
            <form action="<?= BASE_URL ?>/public/index.php?page=createproperty" method="POST" enctype="multipart/form-data" class="space-y-6">
                <div>
